//returns the index of the card that will be swapped, -1 if neither card will be swapped
	public static int swap_alg(ArrayList<Card> board, Card c1, Card c2){
		...
		return determineSwap(flag1, flag2, c1, c2);
	}
	...
	private static int determineSwap(boolean flag1, boolean flag2, Card c1, Card c2) {
		if (flag1 && flag2) { //both cards are swappable; swap lower card
